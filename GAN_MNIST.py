# importing libraries and the MNIST dataset
...
# Both the networks have two hidden layers and an output layer which are densely or fully connected layers defining the Generator network function
...
# defining the learning rate, batch size, number of epochs and using the Adam optimizer
