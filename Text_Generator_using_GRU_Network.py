...
# temperature determines the freedom the function has when generating text
	...
	# the probability of each character to be the next character in the generated text
	probas = np.random.multinomial(1, preds, 1)

	# Returning the character with maximum probability 
	# to be the next character in the generated text
...
# Defining a custom callback function to describe the internal states of the network
...
## output can be significantly improved by training the model for more epochs
